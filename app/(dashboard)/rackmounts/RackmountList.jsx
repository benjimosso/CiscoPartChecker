  ...
  return (
    ...
    >
      <div className="flex items-center">
        {data.image ? <Image src={data.image} alt="Rackmount Image" width={100} height={100} className="w-20 h-20" /> : <Image src={noImage} alt="No Image Available" className="w-20 h-20" />}
